...
<head>
    ...
    <title>Logic & Planning Lab</title>
    <style>
        :root {
...
<div class="container">
    ...
    <div id="tab-1" class="exercise-section" style="display:none">
        <h2>✍️ Mixed Sentence Writing</h2>
...
<script>
    const data = [
        { word: "board games", def: "Games like Chess or Monopoly.", sents: ["We played ___ for three hours last night.", "Which ___ are your favorite?"] },
        { word: "average", def: "Normal, standard, or the middle result of a sum.", sents: ["The ___ temperature in July is 80 degrees.", "He is of ___ height for a man."] },
        { word: "far away", def: "At a great distance.", sents: ["I can't see the sign because it is too ___.", "His office is ___ from the city center."] },
        { word: "switch off", def: "To turn off or to stop paying attention.", sents: ["Don't forget to ___ the lights before leaving.", "I like to ___ my phone during dinner."] },
        { word: "inquiries", def: "Questions or requests for information.", sents: ["We have received many ___ about the new job.", "Please send all ___ to the customer service email."] },
        { word: "wise", def: "Having or showing experience, knowledge, and good judgment.", sents: ["It was a ___ decision to save your money.", "The old man gave us some ___ advice."] },
        { word: "beforehand", def: "Prior to a particular event; in advance.", sents: ["You should book your tickets ___ to get a discount.", "I prepared everything ___ so I wouldn't be stressed."] }
    ];
